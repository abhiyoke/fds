t=int(input(""))
while(t>0):
 n=int(input("enter no. of students in compA:"))
 m=int(input("enter no. of students in compB:"))
 ...
 for i in range(0,n):
  l=[]
  p=int(input("ener prn:"))
  l.append(p)
  d=int(input("ener date:"))
  l.append(d)
  mo=int(input("ener month:"))
  l.append(mo)
  ca.append(l)
 ...
 for i in range(0,m):
  l1=[]
  p1=int(input("ener prn:"))
  l1.append(p1)
  d1=int(input("ener date:"))
  l1.append(d1)
  mo1=int(input("ener month:"))
  l1.append(mo1)
  cb.append(l1)
